...
import 'file:///D:/MegaXtudio/megaride/lib/Home/mainScreen.dart';

class driverReg extends StatefulWidget {
  static const String idScreen = "driverReg";

  @override
  _driverRegState createState() => _driverRegState();
}
...
class _driverRegState extends State<driverReg> {
  ...
  {
    FirebaseFirestore.instance.collection("driver").doc(fUser.uid).set({
      "uid": fUser.uid,
      "email": fUser.email,
      "name": nameTextEditingController.text.trim(),
      "role" : MegaRideApp.driverRole,
    });
    await MegaRideApp.sharedPreferences.setString("uid", fUser.uid);
    await MegaRideApp.sharedPreferences.setString(MegaRideApp.driverEmail, fUser.email);
    await MegaRideApp.sharedPreferences.setString(MegaRideApp.driverName, nameTextEditingController.text);
    await MegaRideApp.sharedPreferences.setString(MegaRideApp.driverRole, "driver");
  }
